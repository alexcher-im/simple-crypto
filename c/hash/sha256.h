// SHA256 implementation, https://github.com/983/SHA-256, Unlicense license
//
// How to use:
//
// get hex string:
//    char hex[SHA256_HEX_SIZE]; // Hex-string, including null-terminator
//    sha256((void*) source_bytes, source_size, hex);
//
/////////////
//
// get bytes:
//    uint8_t out_bytes[SHA256_BYTES_SIZE];
//    sha256_bytes((void*) source_bytes, source_size, out_bytes);
//
/////////////
//
// streaming:
//    struct sha256 sha;
//    sha256_init(&sha);
//    sha256_append(&sha, (void*) source_bytes, source_size); // Adding source bytes. can be called multiple times
//    uint8_t out_bytes[SHA256_BYTES_SIZE];
//    sha256_finalize_bytes(&sha, out_bytes);
//
